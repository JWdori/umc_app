...
import com.example.hw8_2.BusinessCard
import com.example.hw8_2.databinding.ListviewItemBinding
...
class CustomAdapter(context: Context,private val businessCardArraylist:ArrayList<BusinessCard>): BaseAdapter() {
    ...
    override fun getView(position: Int, p1: View?, p2: ViewGroup?): View {
        ...
        binding.editMain.text=businessCardArraylist[position].contents
        return binding.root
